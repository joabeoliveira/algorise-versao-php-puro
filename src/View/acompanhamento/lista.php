                ...
                <tr>
                    ...
                    <td>
                        <?php if (!empty($solicitacao['caminho_anexo'])): ?>
                            <a href="/download.php?file=<?= htmlspecialchars($solicitacao['caminho_anexo']) ?>" class="btn btn-sm btn-outline-primary" title="<?= htmlspecialchars($solicitacao['nome_original_anexo']) ?>">
